...
<br />
<font color="#FF9900" size="+1" ></font><font></font>
...
<div>
<font color="#006699" >标&nbsp;&nbsp;&nbsp;&nbsp;题：</font><input type="text" name="title" size="50">
<br>
<br>
<font color="#006699">链接地址:</font><input type="text" name="content" size="50">
<br>
<br>
...
<input type="hidden" id="input" style="width:400px; height:200px">
