...
public class AlbumSearchMyselfServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public AlbumSearchMyselfServlet(){
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Vector<AlbumBean> vec = userdao.SearchMyselfAlbum(userid);//自己的相册bean集合
		...
		session.setAttribute("albumtype",1);
