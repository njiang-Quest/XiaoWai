...
public class ErshouSearchFromPriceServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public ErshouSearchFromPriceServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap pagemap = new HashMap();//分页map
        String endprice =  request.getParameter("endprice");
        String uctypeid = request.getParameter("uctypeid");
        UserDao userdao = new UserDao(); 
        Vector vec = userdao.SearchUsedGoodsFromPrice(uctypeid,startprice,endprice);//找出来的vec
