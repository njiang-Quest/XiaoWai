...
public class StoreSearchFromtitleAndtype extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public StoreSearchFromtitleAndtype() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Vector vec = (Vector) session.getAttribute("storetypevec");
		System.out.println("类型关键字搜索:"+vec.size());
